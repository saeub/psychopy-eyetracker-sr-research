...
class EyeTracker(EyeTrackerDevice):
    ...
    def bitmapBackdrop(self, iwidth, iheight, pixels, xs, ys, width, height, xd, yd, xferoptions):
        """
    	bitmapBackdrop transfers a bitmap image to the tracker PC as backdrop for gaze cursors.
        ...
        """
        try:
            self._eyelink.bitmapBackdrop(iwidth, iheight, pixels, xs, ys, width, height, xd, yd, xferoptions)
        except Exception:
            printExceptionDetailsToStdErr()
